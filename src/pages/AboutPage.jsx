    ...
    <section className="about-page">
      <div className="about-hero">
        <div className="gs-container">
          <h1>About <span className="gs-accent-text">Gyan Setu</span></h1>
          <p className="about-intro">
            Gyan Setu is a YouTube channel focused on Class 9 and 10 Mathematics based on the NCERT syllabus.
